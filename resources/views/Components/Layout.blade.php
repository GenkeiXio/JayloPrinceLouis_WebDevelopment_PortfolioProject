    ...
    @if(!isset($hideNavAndFooter) || !$hideNavAndFooter)
        <header class="site-header">
            ...
            <nav class="nav">
                ...
                <a href="{{ route('menu', ['username' => $username]) }}" class="{{ request()->is('menu/*') ? 'active' : '' }}">Lab Activities</a>
                <a href="{{ route('aboutus', ['username' => $username]) }}" class="{{ request()->is('aboutus/*') ? 'active' : '' }}">About Me</a>
